            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">May 20,2023</option>
                        <option value="13-3">May 21,2023</option>
                        <option value="14-3">May 22,2023</option>
                        <option value="15-3">May 23,2023</option>
                        <option value="16-3">May 24,2023</option>
                    </select>
