...
<body>
	...
	<div class="invoice-box">
						...
						<tr>
							<td class="title">
								<div class="footer-brand">
									<h1 class="footer-heading">Get Me A Seat</h1>
								</div>
							</td>
							<td>
		...
		<img src="https://api.qrserver.com/v1/create-qr-code/?data={orderid:<?php echo $ORDERID; ?>}&amp;size=120x120" alt="" title="" />
	</div>
	...
	<div style="max-width: 300px; margin:auto; padding: 30px;">
		...
		<a type="button" class="btn btn-success" href='./'>Home-Page</a>
	</div>
